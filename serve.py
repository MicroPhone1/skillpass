...
# -*- coding: utf-8 -*-
"""
serve.py — เซิร์ฟเวอร์สำหรับพัฒนา/สาธิต SkillPass
...
def banner(scheme: str, port: int, ip: str, secure: bool):
    line = "─" * 58
    print()
    print(C["blue"] + C["b"] + "  SkillPass" + C["off"] + C["dim"] + "  ระบบเตรียมความพร้อมและฝึกทักษะ" + C["off"])
...
def main():
    ap = argparse.ArgumentParser(description="SkillPass dev server")
